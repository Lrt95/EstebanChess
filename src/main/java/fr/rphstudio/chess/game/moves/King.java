...
public class King implements IMove {
    ...
    public List<IChess.ChessPosition> getPieceMoves(IChess.ChessPosition position, Board board) {
        ...
        try {
            ...
            if((board.getPieces(pTour1).getPieceType() == IChess.ChessType.TYP_ROOK &&
                    board.getPieces(pTour1).getCounterMove() == 0 && board.getPieces(position).getCounterMove() == 0)){
            ...
            if((board.getPieces(pTour2).getPieceType() == IChess.ChessType.TYP_ROOK &&
                    board.getPieces(pTour2).getCounterMove() == 0 && board.getPieces(position).getCounterMove() == 0)){
